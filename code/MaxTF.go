...
func MaxPointerPointerPointerPointerUint8(pvalues ...****uint8) (uint8, error) {
	values := make([]uint8, 0)
...
func MaxPointerPointerPointerPointerUint16(pvalues ...****uint16) (uint16, error) {
...
func MaxPointerPointerPointerPointerFloat64(pvalues ...****float64) (float64, error) {
...
func MaxPointerPointerPointerPointerString(pvalues ...****string) (string, error) {
...
func MaxPointerPointerPointerPointerInt8(pvalues ...****int8) (int8, error) {
	values := make([]int8, 0)
	for _,value := range pvalues { values = append(values, ****value)}
...
func MaxPointerPointerPointerPointerInt16(pvalues ...****int16) (int16, error) {
	values := make([]int16, 0)
	for _,value := range pvalues { values = append(values, ****value)}
...
func MaxPointerPointerPointerPointerInt64(pvalues ...****int64) (int64, error) {
	values := make([]int64, 0)
	for _,value := range pvalues { values = append(values, ****value)}
...
func MaxPointerPointerPointerPointerUint(pvalues ...****uint) (uint, error) {
	values := make([]uint, 0)
	for _,value := range pvalues { values = append(values, ****value)}
...
func MaxPointerPointerPointerPointerUint32(pvalues ...****uint32) (uint32, error) {
...
func MaxPointerPointerPointerPointerUint64(pvalues ...****uint64) (uint64, error) {
...
func MaxPointerPointerPointerPointerFloat32(pvalues ...****float32) (float32, error) {
...
func MaxPointerPointerPointerPointerInt(pvalues ...****int) (int, error) {
	values := make([]int, 0)
	for _,value := range pvalues { values = append(values, ****value)}
...
func MaxPointerPointerPointerPointerInt32(pvalues ...****int32) (int32, error) {
	values := make([]int32, 0)
	for _,value := range pvalues { values = append(values, ****value)}
